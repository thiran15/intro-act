...
apps.config(['$routeProvider', 'usertypeProvider', function ($routeProvider, usertypeProvider, $rootScope) {
	...
	$routeProvider.when('/newdealflow', {
		templateUrl: 'partials/common/newdealflowstatic.html'+refresh,
		controller: 'newdealflowstaticCtrl'
	});
	...
	$routeProvider.when('/newslettercategory/:hashId', {
		templateUrl: 'partials/common/newslettercategory.html'+refresh,
		controller: 'newslettercategoryCtrl'
	});
	...
	$routeProvider.when('/subscribescorecard', {
		templateUrl: function () {
			return 'partials/common/tickerreport.html'+refresh;
		},
		controller: 'tickerreportCtrl'
	...
	$routeProvider.when('/targetreportfailed', {
		templateUrl: function () {
			return 'partials/common/targetreportfailed.html'+refresh;
		},
		controller: 'tickerreportCtrl'
	});

	$routeProvider.when('/targetreportsuccess', {
		templateUrl: function () {
			return 'partials/common/targetreportsuccess.html'+refresh;
		},
		controller: 'tickerreportCtrl'
	});

	$routeProvider.when('/requestscorecard', {
		templateUrl: function () {
			return 'partials/common/reqscorecard.html'+refresh;
		},
		controller: 'requestscorecardCtrl'
	});
	...
	$routeProvider.when('/fintecharchive', {
		templateUrl: function () {
			return 'partials/common/fintecharchive.html'+refresh;
		},
		controller: 'fintecharchiveCtrl'
	});

	$routeProvider.when('/metaversearchive', {
		templateUrl: function () {
			return 'partials/common/metaversearchive.html'+refresh;
		},
		controller: 'metaversearchiveCtrl'
	});

	$routeProvider.when('/mobilityarchive', {
		templateUrl: function () {
			return 'partials/common/mobilityarchive.html'+refresh;
		},
		controller: 'mobilityarchiveCtrl'
	});


    $routeProvider.when('/disruptivetecharchive', {
		templateUrl: function () {
			return 'partials/common/disruptivetecharchive.html'+refresh;
		},
		controller: 'disruptivetecharchiveCtrl'
	});


    $routeProvider.when('/healthcarearchive', {
		templateUrl: function () {
			return 'partials/common/healthcarearchive.html'+refresh;
		},
		controller: 'healthcarearchiveCtrl'
	});

    $routeProvider.when('/agtecharchive', {
		templateUrl: function () {
			return 'partials/common/agtecharchive.html'+refresh;
		},
		controller: 'agtecharchiveCtrl'
	});

    $routeProvider.when('/cleantecharchive', {
		templateUrl: function () {
			return 'partials/common/cleantecharchive.html'+refresh;
		},
		controller: 'cleantecharchiveCtrl'
	}); 
	...
	$routeProvider.when('/esgarchive', {
		templateUrl: function () {
			return 'partials/common/esgarchive.html'+refresh;
		},
		controller: 'esgarchive'
	});
	...
	$routeProvider.when('/esgs/:dailyId', {
		templateUrl: function () {
			return 'partials/common/dailymailview.html'+refresh;
		},
		controller: 'dailyesgs_viewCtrl'
	});
